...
export const API = {
  ...
  // C-side (求职者)
  GEEK_RECOMMEND_JOBS: '/wapi/zpgeek/recommend/job/list.json',
  GEEK_SEARCH_JOBS: '/wapi/zpgeek/search/joblist.json',
  GEEK_JOB_DETAIL: '/wapi/zpgeek/job/detail.json',
  GEEK_FRIEND_LIST: '/wapi/zprelation/friend/getGeekFriendList.json',
};
